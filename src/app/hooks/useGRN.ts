...
const MOCK_EDGES = [
  ...
  },
  {
    ...
    source: "NANOG",
    target: "KLF4",
    supporting_algorithms: ["GENIE3", "SCODE", "SCINGE"],
    scores_by_algorithm: {
      GENIE3: 0.76,
      SCODE: 0.73,
      SCINGE: 0.75
    ...
    support_count: 3,
    consensus_score: 0.747
  },
  {
    edge_id: "OCT4__MYC",
    source: "OCT4",
    target: "MYC",
    supporting_algorithms: ["GENIE3", "GRNBoost2", "LEAP"],
    scores_by_algorithm: {
      GENIE3: 0.79,
      GRNBoost2: 0.76,
      LEAP: 0.74
    ...
    support_count: 3,
    consensus_score: 0.763
  }
];



export function useGRN(jobId: string) {
